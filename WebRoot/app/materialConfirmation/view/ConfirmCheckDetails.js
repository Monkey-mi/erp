Ext.define('erp.materialConfirmation.view.ConfirmCheckDetails',{
	extend:'erp.ux.Panel',
	...
	initComponent:function(){
		var me = this;
		//检测情况
		me.confirmDetailStore=Ext.create('erp.materialConfirmation.store.MaterialCheckDetail');
		//检测类型
			...
			items:[{
				...
				tbar:[{text:'添加',glyph:0xf055,itemId:erp.def.Const.FUNC_ITEMID_BTN_ADD,hidden:!me.canEdit,
					handler:function(){
						...
						var r = Ext.create('erp.materialConfirmation.model.MaterialCheckDetail',{confirmation_id:me.confirmation_id,checkclass_id:1,chec_date:new Date()});
						store.insert(0,r);}},
