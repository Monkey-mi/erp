Ext.define('erp.materialConfirmation.view.ConfirmDetails',{
	extend:'erp.ux.Panel',
	...
	initComponent:function(){
		var me = this;
		//物料确认明细
		me.confirmDetailStore=Ext.create('erp.materialConfirmation.store.MaterialConfirmationDetails');
		//检测情况明细
		me.confirmcheckStore=Ext.create('erp.materialConfirmation.store.MaterialCheckDetail');
...
//					});
		...
		Ext.apply(me,{
			...
			items:[{
				...
				overflowY: 'auto',
    			overflowX:'auto',
    			tbar:[{text:'添加',glyph:0xf055,itemId:erp.def.Const.FUNC_ITEMID_BTN_ADD,hidden:!me.canEdit,
							handler:function(){
								...
								var rec=Ext.create('erp.materialConfirmation.model.MaterialConfirmationDetails',
									{confirmation_id:me.confirmation_id});
								store.insert(store.getCount(),rec);
								rowEditing.startEdit(rec);
							}},
						{text:'删除',glyph:0xf014,itemId:erp.def.Const.FUNC_ITEMID_BTN_DEL,hidden:!me.canEdit,
							handler:function(){}}
						],
				items:[{
					xtype:'grid',
