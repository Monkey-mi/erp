/*供应商准入评估管理界面*/
Ext.define('erp.materialConfirmation.view.ConfirmManager',{
	extend:'erp.ux.Panel',
...
//	},
 	initComponent:function(){
 		var me =this;
 		me.store=Ext.create('erp.materialConfirmation.store.MaterialConfirmation');
			...
			items:[
   	  	  	...
   	  	  	dockedItems:[{xtype:'toolbar',dock:'top',itemId:'top_bar',items:[
   	  		    ...
   	  		    {text:'查询',glyph:0xf002,itemId:'btn_search'},
   	  	  		{text: '新增',glyph:0xf234,		itemId:erp.Const.FUNC_ITEMID_BTN_ADD},
   	  		    {text: '修改',glyph:0xf0f0,	itemId:erp.Const.FUNC_ITEMID_BTN_EDT,	disabled:true},
...
//		   	  	  			}},
   	  	  			...
   	  	  			{header: '确认',dataIndex: 'qrbj',width:40,renderer : erp.Util.Staterenderer},
   	  	  			{header: '打印',dataIndex: 'dybj',width:40,renderer : erp.Util.Staterenderer},
		...
		var me=this;
		var recs;
		var grid = me.down('#grd_MaterialConfirm');
		...
		var callback=function(recs,scope){
			var sql  =" update t_app_material_confirmation set dybj=1,dysj=getdate() where confirmation_id="+recs[0].get('confirmation_id');
