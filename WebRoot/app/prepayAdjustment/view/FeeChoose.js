Ext.define('erp.prepayAdjustment.view.FeeChoose', {
	extend : 'erp.ux.Window',
	alias : 'widget.FeeChoose',
	width : 1200,
	title : '费用单选择',
	iconCls : 'page_go',
	height : 600,
	initComponent : function() {
		var me = this;
		me.store = Ext.create('erp.prepayAdjustment.store.FeeChoose');
		var cusConfig = me.field.cusConfig;
		var tzfydh=me.field.up('panel').getSelectionModel().getSelection()[0].get('tzfydh');
		me.store.proxy.extraParams.tzfydh = tzfydh;
		me.store.load();
		Ext.apply(me, {
			layout : {
				type : 'border',
