Ext.define('erp.prepayAdjustment.view.PrepayAgreementChoose', {
	extend : 'erp.ux.Window',
	alias : 'widget.PrepayAgreementChoose',
	width : 1200,
	title : '预付合同选择',
	iconCls : 'page_go',
	height : 600,
	initComponent : function() {
		var me = this;
		me.store = Ext.create('erp.prepayAdjustment.store.PrepayAgreementChoose');
		...
		Ext.apply(me, {
			...
			buttons : [{
						...
						handler : function() {
							...
							var grid = me.down('#PrepayAgreementData');
