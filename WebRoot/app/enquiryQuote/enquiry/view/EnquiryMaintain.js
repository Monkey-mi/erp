Ext.define('erp.enquiryQuote.enquiry.view.EnquiryMaintain',{
								...
								items:[
								{
									...
									handler:function(grid,rowIndex,colIndex){
										...
										handler:function(grid,rowIndex,colIndex){
											...
											window.open('common/downloadFile.srm?file_path='+file_path, 'newwindow','height=400,width=400,top=0,left=100,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
										}
								},{
									iconCls:'delete',
									tooltip:'删除',
