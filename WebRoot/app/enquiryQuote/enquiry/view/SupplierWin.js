Ext.define('erp.enquiryQuote.enquiry.view.SupplierWin',{
    ...
    initComponent:function(){
    	var me =this;
		me.supplierstore=Ext.create('erp.enquiryQuote.enquiry.store.SupplierFile');
    	Ext.apply(me,{  		
    	  layout:'fit',
   	  	  items:[
   	  	  	{
	    		...
	    		columns:[
   	  	  			...
   	  	  			{header: '<div style="text-align:center">供应商名称</div>',dataIndex: 'cpyname_cn',width:160},
