Ext.define('erp.enquiryQuote.enquiry.view.EnquiryManager',{
	extend:'erp.ux.Panel',
	...
	initComponent:function(){
		var me=this;
		me.can_use_btn=true;
		me.store=Ext.create('erp.enquiryQuote.enquiry.store.Enquiry');
		me.detailstore=Ext.create('erp.enquiryQuote.enquiry.store.EnquiryDetail');
		Ext.apply(me.store.proxy.extraParams,{usePaging:true});
		me.materialClassstore=Ext.create('erp.enquiryQuote.enquiry.store.TempMaterialClass');
		me.treeStore=Ext.create('erp.basicdata.materialClass.store.MaterialClassTree');
		me.materialClassstore.load();
		me.distributionstore=Ext.create('erp.enquiryQuote.enquiry.store.EnquiryDistribution');
		me.quotationstore=Ext.create('erp.enquiryQuote.enquiry.store.TempQuotation');
		Ext.apply(me.quotationstore.proxy.extraParams,{usePaging:false});
		me.quotationdetailstore=Ext.create('erp.enquiryQuote.enquiry.store.TempQuotationDetail');
		Ext.apply(me,{
			layout:{
				type:'border',
				padding:2
