Ext.define('erp.enquiryQuote.quoteManager.store.QuotationDetail', {
	extend: 'Ext.data.Store',
	reqiures: ['erp.enquiryQuote.quoteManager.model.QuotationDetail'],
	model: 'erp.enquiryQuote.quoteManager.model.QuotationDetail',
	pageSize: 15,
	proxy: {
		type: 'ajax',
		actionMethods : {  
