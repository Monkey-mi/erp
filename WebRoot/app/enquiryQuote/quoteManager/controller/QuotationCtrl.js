Ext.define('erp.enquiryQuote.quoteManager.controller.QuotationCtrl', {
	extend : 'Ext.app.Controller',
	requires : [
				'erp.ux.PagingBar'
				,'erp.enquiryQuote.quoteManager.store.Quotation'
				,'erp.enquiryQuote.quoteManager.model.QuotationDetail'
				,'erp.enquiryQuote.quoteManager.model.QueryParam'
				],
	views:[	'erp.enquiryQuote.quoteManager.view.QuotationManager'
			,'erp.enquiryQuote.quoteManager.view.QuotationQuery'
		],
	refs:[
		...
		me.control({
			'quotationManager':{
				afterrender:function(cmp){
					...
					//me.panel.loadMain(me.grdmain);
					
					me.query_rec=Ext.create('erp.enquiryQuote.quoteManager.model.QueryParam');
				},
...
//					me.doMaintainAction(erp.Const.FUNC_ITEMID_BTN_EDT);
	...
	checkStatusSame:function(sel_recs,idarray,statusarray){
		var me=this;
		var json=erp.Const.callServiceMethodSync('quote/quotation.do?method=checkStatusSame',{
