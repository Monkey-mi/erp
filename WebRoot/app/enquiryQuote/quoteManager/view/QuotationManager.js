Ext.define('erp.enquiryQuote.quoteManager.view.QuotationManager',{
	extend:'erp.ux.Panel',
	...
	initComponent:function(){
		var me=this;
		me.can_use_btn=true;
		me.store=Ext.create('erp.enquiryQuote.quoteManager.store.Quotation');
		me.detailstore=Ext.create('erp.enquiryQuote.quoteManager.store.QuotationDetail');
