Ext.define('erp.enquiryQuote.quote.controller.QuoteCtrl', {
	extend : 'Ext.app.Controller',
	requires : [
				'erp.ux.PagingBar',
				'erp.enquiryQuote.quote.store.Enquiry',
				'erp.supplier.store.MaterialClass',
				'erp.enquiryQuote.quote.store.EnquiryDetail',
				'erp.enquiryQuote.quote.store.Quotation',
				'erp.enquiryQuote.quote.store.QuotationDetail'
				],
	views : [
				'erp.enquiryQuote.quote.view.QuoteManager'
			],
	refs : [
	...
	doClickAction:function(btn){
		...
		switch(btn.itemId){
			case 'BTN_ADD_QuotationDetail':
				...
				var newrec=Ext.create('erp.enquiryQuote.quote.model.QuotationDetail',{
					item_order:maxorder
				});
	...
	checkStatusSame:function(sel_rec){
		...
		var json=erp.Const.callServiceMethodSync('quote/quotation.srm?method=checkStatusSame',{
			quotation_id:quotation_id,
