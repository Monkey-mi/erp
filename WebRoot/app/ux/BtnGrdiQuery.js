Ext.define('erp.ux.BtnGrdiQuery', {
    	...
    	if(me.queryWin == null){
    		...
    		var fieldset = Ext.create('Ext.form.FieldSet',{
			        ...
			        items: [
			        	...
			        	{xtype:'button',text: '添加',iconCls:'fa fa-plus',width:80,handler:onAdd}
			        ]
			});
    		...
    		var treePanel = Ext.create("Ext.tree.Panel",{store:store,rootVisible:false,tbar:[formPanel],hideHeaders: true,
    			columns:[
    				...
    				{xtype:'actioncolumn',menuDisabled:true,sortable:false,width:80,align:'center',items: [{
	                    iconCls: 'fa fa-times',tooltip: '删除记录',handler:function(tree,rowIndex,colIndex,item,e,record,row){
