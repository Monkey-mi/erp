...
Ext.define('erp.ux.ToggleSlide', {
    ...
    onRender: function()
    {
        ...
        {
            Jfok.lib.ToggleSlide.superclass.disable.call(me);
        }
    },
    ...
    enable: function()
    {
        if(this.disabled)
        {
            erp.ux.ToggleSlide.superclass.enable.call(this);
    ...
    disable: function()
    {
        if(!this.disabled)
        {
            erp.ux.ToggleSlide.superclass.disable.call(this);
