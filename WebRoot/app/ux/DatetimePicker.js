Ext.define('erp.ux.DatetimePicker', {
    ...
    afterRender: function() {
        ...
        me.timePicker = Ext.create('Ext.menu.Menu', {
            ...
            //alwaysOnTop:true,
            border: true,
            style:'border-left-style:solid;border-right-style:solid;border-bottom-style:solid;border-left-color:#1b376c;border-right-color:#1b376c',
            defaults: {
                flex: 1
            },
            height: 70,
            ...
            items: [
                {
                    ...
                    width: '100%',
                    items:[ me.hourSlider,{html:':',padding:'5 3 5 0'}, me.minuteSlider,{html:':',padding:'5 3 5 0'},me.secondSlider]
                }
            ]
    ...
    showTimePicker: function() {
        ...
        Ext.defer(function() {
            ...
            $('.x-datepicker').css('border-bottom-color','White');
            $('.x-datepicker').css('border-bottom-width','0px');
            if (backgroundColor == 'transparent') {
                toolbar.setStyle('background-color', '#1b376c');
                toolbar.setStyle('border-style', 'solid');
                toolbar.setStyle('border-color', '#1b376c');
            }
        }, 1);
    },
