...
Ext.define('erp.basic.view.MngBasicData', {
	extend : 'erp.ux.Panel',
...
//			}
//		});
		me.codestore = erp.DataUtil.createStoreFactory('erp.basic.store.Codes');
		me.codestore.getProxy().setExtraParam('usePaging',true);
		me.store = erp.DataUtil.createStoreFactory('erp.basic.store.CodeTypes');
...
//										}
								...
								listeners :{
									...
									itemdblclick : function(view, rec){
										//if(!view.up('mng_CodeType').modFuncsDisabled[erp.Const.FUNC_ITEMID_BTN_EDT])
