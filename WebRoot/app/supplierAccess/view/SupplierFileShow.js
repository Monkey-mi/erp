//注册附件
Ext.define('erp.supplierAccess.view.SupplierFileShow',{
	extend:'erp.ux.Panel',
	...
	initComponent:function(){
		...
		me.registerAttchedStore.proxy.api.read='supplierAccess/common.srm?method=getAttchedOutList';
		me.customAttchedStore=Ext.create('erp.supplierManager.store.AppCustomAttched');
		me.customAttchedStore.proxy.api.read='supplierAccess/common.srm?method=getAttchedOutList';
