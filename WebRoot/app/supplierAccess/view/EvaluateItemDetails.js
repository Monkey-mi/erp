/*评估项明细*/
Ext.define('erp.supplierAccess.view.EvaluateItemDetails',{
	extend:'erp.ux.Panel',
	overflowY:'auto',
	alias:'widget.access_EvaluateItemDetails',
	requires:[
		'erp.supplierAccess.store.SupplierAccessUploadImg'
	],
	initComponent:function(){
		var me=this;
		//评估准入图示上传
		me.accessUploadImgStore=Ext.create('erp.supplierAccess.store.SupplierAccessUploadImg');
		Ext.apply(me,{
    		...
    		items:[{
				...
				tbar:[{text:'保存',iconCls:'page_save',itemId:'BTN_SAVE',disabled:true},{text:'删除',glyph:0xf014,itemId:'BTN_DEL',disabled:true}],
				...
				items:[{
            			...
            			items: [
                			...
                			{boxLabel: '一般', name: 'rb-score', inputValue: 3},
                			{boxLabel: '满意', name: 'rb-score', inputValue: 4},
                			{boxLabel: '优秀', name: 'rb-score', inputValue: 5}
            			],
						columnWidth:1
					},
					{
    		...
    		},
    		{
		    	...
		    	items:[{
					...
					width:274,
					tbar:[
		    		{text:'添加图片',iconCls:'picture_add',itemId:'addPicture',
		    		...
		    		{text:'删除图片',iconCls:'picture_delete',itemId:'delPicture',disabled:true,handler:function(){
		...
		setAccessScoreData:function(id,parentId){
			...
			var rec;
			Ext.apply(me.accessScore.proxy.extraParams,{item_id:me.item_id,item_fid:me.item_fid,loop_id:me.loop_id});
			...
			me.accessScore.load({
				callback:function(records,operation,success){
					...
					{
						me.isAdd=true;
						rec=Ext.create('erp.supplierAccess.model.SupplierAccessScore',{
						loop_id:me.loop_id,
						item_id:me.item_id,
