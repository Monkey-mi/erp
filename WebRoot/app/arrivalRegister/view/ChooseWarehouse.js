Ext.define('erp.arrivalRegister.view.ChooseWarehouse',{
    extend : 'erp.ux.Window',
    alias: 'widget.Choose_Warehouse',
    requires: ['erp.arrivalRegister.store.ArrivalRegister',
    ...
    initComponent : function(){
       	  var me=this;
       	  me.store = Ext.create('erp.arrivalRegister.store.Warehouse'); 
       	  me.rec = Ext.create('erp.arrivalRegister.model.Warehouse')
       	  Ext.apply(me,{
              layout: {
                 type: 'fit',
              	 pack: 'start',
