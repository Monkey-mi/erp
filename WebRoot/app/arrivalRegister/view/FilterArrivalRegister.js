Ext.define('erp.arrivalRegister.view.FilterArrivalRegister',{
    extend : 'erp.ux.Window',
    alias : 'widget.Filter_ArrivalRegister',
    iconCls:'page_find',
    title:'到货登记管理筛选条件',
    modal:true,
    width:470,
             ...
             for(var x in obj){
                if(!Ext.isEmpty(obj[x])){
                   if(x=='dhdh1' && obj['checkbox_dhdh']){
					 ...
					 arr.push(me.prefix+"csbh = '"+obj[x]+"' or csxxb.csmc like '%"+obj[x]+"%'");
