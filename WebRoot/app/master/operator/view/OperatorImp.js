Ext.define('erp.master.operator.view.OperatorImp',{
	extend:'erp.ux.Window',
	requires:['erp.master.operator.store.Operator','erp.ux.SearchCombobox'],
	alias:'widget.imp_OperatorImp',
//	plugins : {
//		ptype : 'FormKey'
//	},
	width:900,
		...
		Ext.apply(me,{
			...
			items:[{
				...
				columns:[{header: '工号',dataIndex: 'czy_gh',flex:2},
						{header: '操作员 ',dataIndex: 'czy_xm',flex: 3},						
				...
				dockedItems:[{
					...
					items:[{xtype:'tps_searchcbo',itemId:'search',fieldLabel:'快速查询',emptyText:'输入操作员名',labelWidth:80,
   	  					hideTrigger:true,
   	  			 		store:me.store,
		    	 		displayField:'czy_gh',
