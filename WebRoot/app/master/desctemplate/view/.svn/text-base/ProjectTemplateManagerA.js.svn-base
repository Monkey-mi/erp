Ext.define('erp.master.desctemplate.view.ProjectTemplateManagerA',{
	extend:'erp.ux.Window',
    alias:'widget.mng_ProjectTemplateManagerA',
    iconCls:'box',
    requires:[	
    			'erp.ux.PagingBar',
    			'erp.ux.QueryPanel',
...
//    maximizable: true,
   ...
   layout:'border',
    initComponent:function(){
    	var me =this;
 		me.store=Ext.create('erp.master.desctemplate.store.ProjectTemplate');
 		me.detailStore=Ext.create('erp.master.desctemplate.store.ProjectTemplateDetail');
 		me.descStore=Ext.create('erp.master.foreignTrade.proDescription.store.ProDescription');
