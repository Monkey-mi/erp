/*分数汇总信息页面*/
Ext.define('erp.supplierManager.view.accessToEvaluate.ScoreCollectInfo',{
	extend:'erp.ux.Panel',
	alias:'widget.access_ScoreCollectInfo',
	requires:['erp.supplierManager.view.accessToEvaluate.EvaluateCharts'
			],
	height:800,
	overflowY: 'auto',
...
//    });
		me.scoreSummaryStore=Ext.create('erp.supplierManager.store.AccessScoreSummary');
