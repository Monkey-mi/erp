/*经营状况与管理策略*/
Ext.define('erp.supplierManager.view.accessToEvaluate.evaluateDetails.EvaluateDetailsOne',{
	extend:'erp.ux.Panel',
	overflowY:'auto',
	alias:'widget.access_EvaluateDetailsOne',
	requires:['erp.supplierAccess.store.SupplierAccessUploadImg'],
    ...
    me.scoreDetailsStore=Ext.create('erp.supplierManager.store.SupplierAccessScoreDetails');
    //me.imgStore=Ext.create('erp.supplierAccess.store.SupplierAccessUploadImg');
		Ext.apply(me,{
//			layout:{
//		     type: 'vbox',//垂直分布
//		     align: 'stretch'
//    		},
    		...
    		items:[{
				...
				columns:[
					...
					{header:'<div style="text-align:center">一般</div>',align:'center',dataIndex: 'score3',xtype:'numbercolumn',width:100,
    					renderer:function(v){if(v==3) return '√';else return '';},
    					summaryType: 'sum',
						summaryRenderer: function(value, summaryData, dataIndex) {
							return Ext.util.Format.number(value,'0');
						}
...
//			var imgStore=Ext.create('erp.supplierAccess.store.SupplierAccessUploadImg');
//			imgStore.load(
