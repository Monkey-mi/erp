Ext.define('erp.supplierManager.view.purchasingInquiry.GeneralTemplate',{
	extend:'erp.ux.Panel',
	alias:'widget.Pi_GeneralTemplate',
	requires:['erp.supplierManager.view.purchasingInquiry.common.TemplateTop',
	'erp.supplierManager.view.purchasingInquiry.common.TemplateBottom'],
