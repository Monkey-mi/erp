//注册附件
Ext.define('erp.supplierManager.view.SupplierFileInfo',{
	extend:'erp.ux.Panel',
	alias:'widget.SupplierFileInfo',
	requires:['erp.supplierManager.view.SupplierFileUpLoad'],
	isAdd:false,
	isEdit:false,
	//overflowY: 'auto',
	//height:800,
				...
				,{
					...
					items:[
					{
						...
						handler:function(grid,rowIndex,colIndex){
							...
							window.open('supplier/downloadAttched.srm?file_path='+file_path, 'newwindow','height=400,width=400,top=0,left=100,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
						}
...
//									me.hiddenPic('PIC1');
							...
							erp.Const.callServiceMethodSync('supplier/deleteAttchedByPath.srm',{
...
//				   	  	  	]
			...
			,{
				...
				itemId:'customGrid',
				tbar:[{
					text:'自定义添加',glyph:0xf055,itemId:'BTN_ADD',hidden:!me.isEdit,handler:function(){
						...
						var r = Ext.create('erp.supplierManager.model.AppRegisterAttched',{"company_id":company_id, "create_dt":new Date(),"file_path":"",ismust:false,remark:'',iscustom:true});
				...
				{
					text:'删除',glyph:0xf014,itemId:'BTN_DEL',hidden:!me.isEdit,handler:function(){
						Ext.Msg.confirm('提示','你确定要删除当前上传文件?',function(btn){
			 			if(btn=='yes')
			 			{
			 			var grid=me.down('#customGrid');
   ...
   loadGridData:function(rec){
	...
	setDefaultData:function(company_id){
		...
		var array=[];
			...
			var file1=Ext.create('erp.supplierManager.model.AppRegisterAttched',{company_id:company_id,file_name:'营业执照',create_dt:create_dt,file_format:'jpg/jpeg/png/gif/bmp',ismust:true,remark:'请上传图片格式，如jpg,jpeg,png,gif,bmp',iscustom:false});
			var file2=Ext.create('erp.supplierManager.model.AppRegisterAttched',{company_id:company_id,file_name:'税务登记证',create_dt:create_dt,file_format:'jpg/jpeg/png/gif/bmp',ismust:true,remark:'请上传图片格式，如jpg,jpeg,png,gif,bmp',iscustom:false});
			var file3=Ext.create('erp.supplierManager.model.AppRegisterAttched',{company_id:company_id,file_name:'组织机构代码证',create_dt:create_dt,file_format:'jpg/jpeg/png/gif/bmp',ismust:true,remark:'请上传图片格式，如jpg,jpeg,png,gif,bmp',iscustom:false});
			var file4=Ext.create('erp.supplierManager.model.AppRegisterAttched',{company_id:company_id,file_name:'公司介绍',create_dt:create_dt,file_format:'word/pdf/excel/rar/zip',ismust:false,remark:'文件大小不得超过10M',iscustom:false});
			var file5=Ext.create('erp.supplierManager.model.AppRegisterAttched',{company_id:company_id,file_name:'厂容厂貌',create_dt:create_dt,file_format:'jpg/jpeg/png/gif/bmp',ismust:false,remark:'请上传图片格式，如jpg,jpeg,png,gif,bmp',iscustom:false});
			var file6=Ext.create('erp.supplierManager.model.AppRegisterAttched',{company_id:company_id,file_name:'认证体系证书复印件',create_dt:create_dt,file_format:'jpg/jpeg/png/gif/bmp',ismust:false,remark:'文件大小不得超过10M',iscustom:false});
			var file7=Ext.create('erp.supplierManager.model.AppRegisterAttched',{company_id:company_id,file_name:'公司/工厂机器设备清单',create_dt:create_dt,file_format:'jpg/jpeg/png/gif/bmp/word/pdf/excel/rar/zip',ismust:false,remark:'文件大小不得超过10M',iscustom:false});
			var file8=Ext.create('erp.supplierManager.model.AppRegisterAttched',{company_id:company_id,file_name:'代理商/贸易商需提供代理证明资质',create_dt:create_dt,file_format:'jpg/jpeg/png/gif/bmp',ismust:false,remark:'请上传图片格式，如jpg,jpeg,png,gif,bmp',iscustom:false});
			var file9=Ext.create('erp.supplierManager.model.AppRegisterAttched',{company_id:company_id,file_name:'同类产品国家认定机构检测报告或行业出具的等级证明、优质产品证书、知识产权证书复印件',create_dt:create_dt,file_format:'jpg/jpeg/png/gif/bmp',ismust:false,remark:'请上传图片格式，如jpg,jpeg,png,gif,bmp',iscustom:false});
			var file10=Ext.create('erp.supplierManager.model.AppRegisterAttched',{company_id:company_id,file_name:'与院校、科研机构合作、交流情况(提供相关文件复印件)',create_dt:create_dt,file_format:'jpg/jpeg/png/gif/bmp',ismust:false,remark:'请上传图片格式，如jpg,jpeg,png,gif,bmp',iscustom:false});
			array.push(file1);
			array.push(file2);
			array.push(file3);
			array.push(file4);
