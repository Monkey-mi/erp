//采购询价单列表页面
Ext.define('erp.supplierManager.view.PurchasingInquiryList',{
	extend:'erp.ux.Panel',
	requires:['erp.supplierManager.store.TempQuotation',
	...
	initComponent:function(){
		var  me=this;
		me.store=Ext.create('erp.supplierManager.store.TempQuotation');
		me.detailstore=Ext.create('erp.enquiryQuote.quote.store.QuotationDetail');
