/*供应商物料确认信息页面*/
Ext.define('erp.supplierManager.view.materialConfirm.SupplierMaterialConfirm',{
	extend:'erp.ux.Panel',
	...
	initComponent:function(){
		var me=this;
		me.materialConformstore=Ext.create('erp.materialConfirmation.store.MaterialConfirmation');
