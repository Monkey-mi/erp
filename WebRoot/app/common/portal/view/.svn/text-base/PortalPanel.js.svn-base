/**
 * @class erp.common.portal.view.PortalPanel
 * @extends Ext.panel.Panel
 * A {@link Ext.panel.Panel Panel} class used for providing drag-drop-enabled portal layouts.
 */
Ext.define('erp.common.portal.view.PortalPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.portalpanel',

    requires: [
        'Ext.layout.container.Column',
        'erp.common.portal.view.PortalDropZone',
        'erp.common.portal.view.PortalColumn'
    ],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('erp.common.portal.view.PortalDropZone', this, this.dropConfig);
    },
