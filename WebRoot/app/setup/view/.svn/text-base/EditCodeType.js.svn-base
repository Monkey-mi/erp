 ...
 */
Ext.define('erp.setup.view.EditCodeType', {
	extend : 'erp.ux.Window',
	alias : 'widget.edt_CodeType1',
		    	 ...
		    	 items : [
					        {
								...
								plugins : {
									...
									rvOptions : {
										url : 'main/CodeCheck.do?method=isExistsCodeType',
							...
							}, 
							{
								...
								store : Ext.create('Ext.data.Store', {
											...
											data : [{
														name : '系统',
														value : erp.Const.TYPE_ATTRIB_SYS
													}, {
														name : '下拉',
														value : erp.Const.TYPE_ATTRIB_CBX
													}, {
														name : '应用',
														value : erp.Const.TYPE_ATTRIB_APP
													}]
										}),
								queryMode : 'local',
								displayField : 'name',
