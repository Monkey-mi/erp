 ...
 * zhandewang
 */
Ext.define('erp.setup.view.EditCode',{
	extend: 'erp.ux.Window',
	alias: 'widget.edt_Code1',
	requires:['erp.setup.store.CodeTypes',
	...
	items:[
		     {  
		    	 ...
		    	 items:[
						{
							xtype:'combobox',
							store: Ext.create('erp.setup.store.CodeTypes'),
							displayField: 'name',
						...
						},
						{
							...
							plugins : {
								...
								rvOptions : {
									url : 'main/CodeCheck.do?method=isExistsCode',
									vFields : ['type_code'],
	...
	initComponent:function(){
		/*var me = this;
		me.comboboxstore=Ext.create('tp.setup.store.CodeTypes',{
			proxy : {
				type : 'ajax',
				actionMethods : 'post',
				api : {
