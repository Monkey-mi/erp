Ext.define('erp.view.master.perchasepriceadjust.view.ProcurementImp',{
	extend:'erp.ux.Window',
	alias:'widget.ProcurementImp',
	width:1200,
	title:'入库单导入',
	iconCls:'page_go',
	height:600,
	...
	initComponent:function(){
		...
		me.store=Ext.create('erp.view.master.perchasepriceadjust.store.ProcurementImp');
		me.store.proxy.extraParams.hsbm=me.hsbm;
		//me.store.load();
		me.selStore=Ext.create('erp.view.master.perchasepriceadjust.store.ProcurementImp');
		...
		Ext.apply(me,{
			...
			items:[{
				...
				columns:[
							...
							{ dataIndex: 'tzdh', header:'结算单号',width:80},
				...
				dockedItems:[
					...
					items:[{xtype:'textfield',fieldLabel:'入库单号',enableKeyEvents :true,itemId:'rkdh',
						...
						fieldConfig:{forceSelection:true},fieldLabel:'供应厂商',enableKeyEvents :true,itemId:'csbh',
							listeners:{keyup:me.onKeyup}},'-',
						{   				
						    labelWidth: 70,                     
	                        boxLabel: '按材料货号查询',
