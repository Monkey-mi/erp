Ext.define('erp.basicdata.companyClass.view.CompanyClassManager',{	
    ...
    initComponent:function(){
    	var me =this;
    	me.store=Ext.create('erp.basicdata.companyClass.store.CompanyClass');
 		...
 		var rowEditing=Ext.create('Ext.grid.plugin.RowEditing', {
			        ...
			        listeners: {
						...
						'validateedit':function(editor,e,obj){
							if(e.record.get('oo')=='000'){			        							
								var rec=e.record;
								var result=erp.Const.callServiceMethodSync('companyClass/companyClass.srm?method=checkForAdd',{
			        			...
			        			var rec=e.record;
								var result=erp.Const.callServiceMethodSync('companyClass/companyClass.srm?method=checkForUpdate',{
										nature_name:e.newValues.nature_name,
										f_id:rec.get('f_id'),
   	  	  	...
   	  	  	dockedItems:[
				  		...
				  		{text: '新增',	glyph : 0xf016,		itemId:erp.Const.FUNC_ITEMID_BTN_ADD
				  			,handler:function(){
								...
								var rec=Ext.create('erp.basicdata.companyClass.model.CompanyClass',{
									oo:'000',
									f_id:0
								});
 	...
 	doDelete: function() {
		...
		var result=erp.Const.callServiceMethodSync('companyClass/companyClass.srm?method=candeleted',{
				nature_id:rec.get('nature_id')
		});
		var result=Ext.decode(result);  
