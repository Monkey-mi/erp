package srm.basicdata.companyClass.controller;
...
import srm.basicdata.companyClass.service.CompanyClassService;
...
public class CompanyClassCtrl {
	...
	/**
	 *企业性质*/
	@RequestMapping(value="/companyClass.srm",method=RequestMethod.POST)
	@ResponseBody 
