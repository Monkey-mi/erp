package srm.basicdata.level.controller;
...
import srm.basicdata.level.service.MaterialLevelService;
@Controller
...
public class MaterialLevelCtrl {
	...
	/**
	 *材料采购登记*/
	@RequestMapping(value="/materialLevel.srm",method=RequestMethod.POST)
	@ResponseBody 
