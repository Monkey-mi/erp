package srm.basicdata.taxmanClass.controller;
...
import srm.basicdata.taxmanClass.service.TaxmanClassService;
@Controller
...
public class TaxmanClassController{
	...
	//物料确认检测类目
	@RequestMapping(value="/TaxmanClass.srm",method=RequestMethod.POST)
	@ResponseBody 
