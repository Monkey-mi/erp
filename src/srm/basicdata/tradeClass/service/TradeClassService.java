package srm.basicdata.tradeClass.service;
...
import srm.basicdata.tradeClass.data.TradeClassMapper;
import srm.basicdata.tradeClass.model.TradeClass;
...
public class TradeClassService {
	...
	*/
	public String checkForUpdate(Map<String,Object> params){
		...
		if(xiajicount>0 && "true".equalsIgnoreCase((String) params.get("leaf"))){
