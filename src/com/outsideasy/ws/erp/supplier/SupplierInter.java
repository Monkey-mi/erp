...
public interface SupplierInter {
	...
	/**获取 验厂报告 附件表
	 * 参数：供应商id supplier_id /准入申请 id record_id
	 * 返回值：json 格式 
	 * @author wuqia
	 * 2016-8-20
	 * */
	 ...
	 *2016-5-12
	 **/
	String updateSupplierFileStateByWS(String jsonmap);
	...
	* @Description: SupplierInter  供应商填写的供货品类，PO需要获取和确认，回传数据到平台(新增+删除)
	* @author 舒飞
	* @date 2016-9-19下午4:49:03
	 */
	void updatePurchaseCategoryByWs(String jsonmap,int record_id);
	
	String deletePfSupplierMaterialcheckByWS(String jsonmap);
	String deletePfSupplierCheckfactoryReportByWs(String jsonmap);
}
