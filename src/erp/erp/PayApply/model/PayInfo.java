...
public class PayInfo {
	...
	private String			fplb;
	private String			fphm;
	private double			syjhbh;
	private double			syjhxh;
	private String			syh;
	private double			fkjhbh;
	private double			fkjhxh;
	private int			yfkbj;
	private String			fkh;
	private double			zdxh;
	private double			zfje;
	...
	public double getZdsx() {
		return zdsx;
	}
	public void setZdsx(double zdsx) {
		this.zdsx = zdsx;
	}
	public String getZfpzh() {
		return zfpzh;
	}
	public void setZfpzh(String zfpzh) {
		this.zfpzh = zfpzh;
	}
	public Date getZfrq() {
		return zfrq;
	...
	public String getZfxs() {
		return zfxs;
	}
	public void setZfxs(String zfxs) {
		this.zfxs = zfxs;
	}
	...
	public void setDfdm(String dfdm) {
		this.dfdm = dfdm;
	}
	...
	public void setHslb(String hslb) {
		this.hslb = hslb;
	}
	...
	public void setQtfx(int qtfx) {
		this.qtfx = qtfx;
	}
	public int getPzbj() {
		return pzbj;
	}
	public void setPzbj(int pzbj) {
		this.pzbj = pzbj;
	}
	...
	public double getPzbh() {
		return pzbh;
	}
	public void setPzbh(double pzbh) {
		this.pzbh = pzbh;
	}
	...
	public double getSyjhbh() {
		return syjhbh;
	}
	public void setSyjhbh(double syjhbh) {
		this.syjhbh = syjhbh;
	}
	public double getSyjhxh() {
		return syjhxh;
	}
	public void setSyjhxh(double syjhxh) {
		this.syjhxh = syjhxh;
	}
	...
	public double getFkjhbh() {
		return fkjhbh;
	}
	public void setFkjhbh(double fkjhbh) {
		this.fkjhbh = fkjhbh;
	}
	public double getFkjhxh() {
		return fkjhxh;
	}
	public void setFkjhxh(double fkjhxh) {
		this.fkjhxh = fkjhxh;
	}
	public int getYfkbj() {
		return yfkbj;
	}
	public void setYfkbj(int yfkbj) {
		this.yfkbj = yfkbj;
	}
	...
	public double getZdxh() {
		return zdxh;
	}
	public void setZdxh(double zdxh) {
		this.zdxh = zdxh;
	}
