package erp.erp.master.prematerial.model;
...
public class Materialname extends Model implements Serializable{
	...
	public double getYxqx() {
		return yxqx;
	}
	public void setYxqx(double yxqx) {
		this.yxqx = yxqx;
	}
	...
	public double getGsbh() {
		return gsbh;
	}
	public void setGsbh(double gsbh) {
		this.gsbh = gsbh;
	}
	public int getSpbj() {
		return spbj;
	...
	public double getHbdj() {
		return hbdj;
	}
	public void setHbdj(double hbdj) {
		this.hbdj = hbdj;
	}
