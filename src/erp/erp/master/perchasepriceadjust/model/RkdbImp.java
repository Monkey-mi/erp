package erp.erp.master.perchasepriceadjust.model;

import java.util.Date;

public class RkdbImp {
	private String			ckbh;
	private double			rkdh;
	private double			rkxh;
	private Date			rkrq;
	...
	private double			pddh;
	private String			shdh;
	private double			nbcbdj;
	private double			nbcbje;
	private String			fzdw;
	private double			fzsl;
	private Date			shsj;
	private double			sqbh;
	...
	private double			glht;
	private double			bzbh;
	private double			rkdh_wms;
	private String			cqbh_wms;
	private String hth;
	private String clmc;
	private String csmc;
	private String cpbh;
	...
	public double getRklb() {
		return rklb;
	}
	public void setRklb(double rklb) {
		this.rklb = rklb;
	}
	...
	public double getHcdh() {
		return hcdh;
	}
	public void setHcdh(double hcdh) {
		this.hcdh = hcdh;
	}
	public double getHcxh() {
		return hcxh;
	}
	public void setHcxh(double hcxh) {
		this.hcxh = hcxh;
	}
	...
	public void setHxrm(String hxrm) {
		this.hxrm = hxrm;
	}
	public Date getHxsj() {
		return hxsj;
	...
	public double getPddh() {
		return pddh;
	}
	public void setPddh(double pddh) {
		this.pddh = pddh;
	}
	...
	public double getNbcbdj() {
		return nbcbdj;
	}
	public void setNbcbdj(double nbcbdj) {
		this.nbcbdj = nbcbdj;
	}
	public double getNbcbje() {
		return nbcbje;
	}
	public void setNbcbje(double nbcbje) {
		this.nbcbje = nbcbje;
	}
	...
	public double getTzxh() {
		return tzxh;
	}
	public void setTzxh(double tzxh) {
		this.tzxh = tzxh;
	}
	public double getXdzl() {
		return xdzl;
	}
	public void setXdzl(double xdzl) {
		this.xdzl = xdzl;
	}
	public int getZsbj() {
		return zsbj;
	}
	public void setZsbj(int zsbj) {
		this.zsbj = zsbj;
	}
	public int getGjbj() {
		return gjbj;
	}
	public void setGjbj(int gjbj) {
		this.gjbj = gjbj;
	}
	public double getFgjh() {
		return fgjh;
	}
	public void setFgjh(double fgjh) {
		this.fgjh = fgjh;
	}
	public double getFgxh() {
		return fgxh;
	}
	public void setFgxh(double fgxh) {
		this.fgxh = fgxh;
	}
	public String getFgcp() {
		return fgcp;
	}
	public void setFgcp(String fgcp) {
		this.fgcp = fgcp;
	}
	...
	public double getGlht() {
		return glht;
	}
	public void setGlht(double glht) {
		this.glht = glht;
	}
	public double getBzbh() {
		return bzbh;
	}
	public void setBzbh(double bzbh) {
		this.bzbh = bzbh;
	}
	public double getRkdh_wms() {
		return rkdh_wms;
	}
	public void setRkdh_wms(double rkdh_wms) {
		this.rkdh_wms = rkdh_wms;
	}
	public String getCqbh_wms() {
		return cqbh_wms;
	}
	public void setCqbh_wms(String cqbh_wms) {
		this.cqbh_wms = cqbh_wms;
	}
