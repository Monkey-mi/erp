...
public class ModuleTree extends Model implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3649145836427644188L;
	...
	private List<ModuleTree> subItem;
	private List<ModuleTree> data;
	public int getId() {
		return id;
	}
	public List<ModuleTree> getSubItem() {
		return subItem;
	}
	public void setSubItem(List<ModuleTree> subItem) {
	...
	public void setMod_code(String modCode) {
		mod_code = modCode;
	}
	...
	public List<ModuleTree> getData() {
		return data;
	}
	public void setData(List<ModuleTree> data) {
		this.data = data;
	}
